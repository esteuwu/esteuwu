...
- [LineageOS](https://review.lineageos.org/q/(author:esteuwu@proton.me+OR+owner:esteuwu@proton.me)+status:merged)
- [Linux kernel](https://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git/log/?h=master&qt=author&q=Esteban+Urrutia)
- postmarketOS
